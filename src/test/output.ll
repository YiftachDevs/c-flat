...
@global_string = private unnamed_addr constant [8 x i8] c"map.txt\00", align 1
@"[c-flat]:count" = internal global i64 0
@global_string.27 = private unnamed_addr constant [29 x i8] c"\0ANOT EVIL ANYMORE SORRY GANG\00", align 1
@global_string.28 = private unnamed_addr constant [9 x i8] c"GOODBYE!\00", align 1
@global_string.29 = private unnamed_addr constant [10 x i8] c"game over\00", align 1
@global_string.30 = private unnamed_addr constant [2 x i8] c"0\00", align 1
...
entry:
  ...
  %file_name = alloca { ptr, i64 }, align 8
  store ptr @global_string, ptr %file_name, align 8
  %file_name.repack25 = getelementptr inbounds nuw i8, ptr %file_name, i64 8
  store i64 7, ptr %file_name.repack25, align 8
  %tmp.unpack = load ptr, ptr %file_name, align 8
  %0 = insertvalue { ptr, i64 } poison, ptr %tmp.unpack, 0
  %tmp.elt26 = getelementptr inbounds nuw i8, ptr %file_name, i64 8
  %tmp.unpack27 = load i64, ptr %tmp.elt26, align 8
  %tmp28 = insertvalue { ptr, i64 } %0, i64 %tmp.unpack27, 1
  %fun_call_tmp = call i1 @"[c-flat]:File:exists"({ ptr, i64 } %tmp28)
  br i1 %fun_call_tmp, label %then, label %merge

merge:                                            ; preds = %entry, %then
  %fun_call_tmp22 = call {} @"[c-flat]:println"({ ptr, i64 } { ptr @global_string.29, i64 9 })
  %fun_call_tmp23 = call {} @"[c-flat]:debug_heap_count"()
  ret i64 0

then:                                             ; preds = %entry
  %tmp1.unpack = load ptr, ptr %file_name, align 8
  %1 = insertvalue { ptr, i64 } poison, ptr %tmp1.unpack, 0
  %tmp1.elt29 = getelementptr inbounds nuw i8, ptr %file_name, i64 8
  %tmp1.unpack30 = load i64, ptr %tmp1.elt29, align 8
  %tmp131 = insertvalue { ptr, i64 } %1, i64 %tmp1.unpack30, 1
  %fun_call_tmp2 = call %"[c-flat]:File" @"[c-flat]:File:open"({ ptr, i64 } %tmp131)
  %2 = extractvalue %"[c-flat]:File" %fun_call_tmp2, 0
  %.elt = extractvalue %"[c-flat]:Vec<T = char>" %2, 0
  store ptr %.elt, ptr %file, align 8
  %file.repack32 = getelementptr inbounds nuw i8, ptr %file, i64 8
  %.elt33 = extractvalue %"[c-flat]:Vec<T = char>" %2, 1
  store i64 %.elt33, ptr %file.repack32, align 8
  %file.repack34 = getelementptr inbounds nuw i8, ptr %file, i64 16
  %.elt35 = extractvalue %"[c-flat]:Vec<T = char>" %2, 2
  store i64 %.elt35, ptr %file.repack34, align 8
  %fun_call_tmp3 = call %"[c-flat]:Vec<T = char>" @"[c-flat]:File:read_text"(ptr nonnull %file)
  %fun_call_tmp3.elt = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp3, 0
  store ptr %fun_call_tmp3.elt, ptr %tmp2, align 8
  %tmp2.repack36 = getelementptr inbounds nuw i8, ptr %tmp2, i64 8
  %fun_call_tmp3.elt37 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp3, 1
  store i64 %fun_call_tmp3.elt37, ptr %tmp2.repack36, align 8
  %tmp2.repack38 = getelementptr inbounds nuw i8, ptr %tmp2, i64 16
  %fun_call_tmp3.elt39 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp3, 2
  store i64 %fun_call_tmp3.elt39, ptr %tmp2.repack38, align 8
  %fun_call_tmp4 = call { ptr, i64 } @"[c-flat]:Vec<T = char>:deref_mut"(ptr nonnull %tmp2)
  %fun_call_tmp5 = call {} @"[c-flat]:println"({ ptr, i64 } %fun_call_tmp4)
  %fun_call_tmp6 = call {} @"[c-flat]:File:clear"(ptr nonnull %file)
  %fun_call_tmp7 = call {} @"[c-flat]:File:write_text"(ptr nonnull %file, { ptr, i64 } { ptr @global_string.27, i64 28 })
  %fun_call_tmp8 = call %"[c-flat]:Vec<T = char>" @"[c-flat]:File:read_text"(ptr nonnull %file)
  %fun_call_tmp8.elt = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp8, 0
  store ptr %fun_call_tmp8.elt, ptr %tmp3, align 8
  %tmp3.repack40 = getelementptr inbounds nuw i8, ptr %tmp3, i64 8
  %fun_call_tmp8.elt41 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp8, 1
  store i64 %fun_call_tmp8.elt41, ptr %tmp3.repack40, align 8
  %tmp3.repack42 = getelementptr inbounds nuw i8, ptr %tmp3, i64 16
  %fun_call_tmp8.elt43 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp8, 2
  store i64 %fun_call_tmp8.elt43, ptr %tmp3.repack42, align 8
  ...
  %fun_call_tmp11 = call {} @"[c-flat]:println"({ ptr, i64 } { ptr @global_string.28, i64 8 })
  %tmp12.unpack = load ptr, ptr %file_name, align 8
  %3 = insertvalue { ptr, i64 } poison, ptr %tmp12.unpack, 0
  %tmp12.elt44 = getelementptr inbounds nuw i8, ptr %file_name, i64 8
  %tmp12.unpack45 = load i64, ptr %tmp12.elt44, align 8
  %tmp1246 = insertvalue { ptr, i64 } %3, i64 %tmp12.unpack45, 1
  %fun_call_tmp13 = call {} @"[c-flat]:File:delete"({ ptr, i64 } %tmp1246)
  %tmp14.unpack = load ptr, ptr %tmp3, align 8
  %4 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp14.unpack, 0
  %tmp14.elt47 = getelementptr inbounds nuw i8, ptr %tmp3, i64 8
  %tmp14.unpack48 = load i64, ptr %tmp14.elt47, align 8
  %5 = insertvalue %"[c-flat]:Vec<T = char>" %4, i64 %tmp14.unpack48, 1
  %tmp14.elt49 = getelementptr inbounds nuw i8, ptr %tmp3, i64 16
  %tmp14.unpack50 = load i64, ptr %tmp14.elt49, align 8
  %tmp1451 = insertvalue %"[c-flat]:Vec<T = char>" %5, i64 %tmp14.unpack50, 2
  %fun_call_tmp15 = call {} @"[c-flat]:Vec<T = char>:drop.13"(%"[c-flat]:Vec<T = char>" %tmp1451)
  %tmp16.unpack = load ptr, ptr %tmp2, align 8
  %6 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp16.unpack, 0
  %tmp16.elt52 = getelementptr inbounds nuw i8, ptr %tmp2, i64 8
  %tmp16.unpack53 = load i64, ptr %tmp16.elt52, align 8
  %7 = insertvalue %"[c-flat]:Vec<T = char>" %6, i64 %tmp16.unpack53, 1
  %tmp16.elt54 = getelementptr inbounds nuw i8, ptr %tmp2, i64 16
  %tmp16.unpack55 = load i64, ptr %tmp16.elt54, align 8
  %tmp1656 = insertvalue %"[c-flat]:Vec<T = char>" %7, i64 %tmp16.unpack55, 2
  %fun_call_tmp17 = call {} @"[c-flat]:Vec<T = char>:drop.13"(%"[c-flat]:Vec<T = char>" %tmp1656)
  %tmp18.unpack.unpack = load ptr, ptr %file, align 8
  %8 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp18.unpack.unpack, 0
  %tmp18.unpack.elt58 = getelementptr inbounds nuw i8, ptr %file, i64 8
  %tmp18.unpack.unpack59 = load i64, ptr %tmp18.unpack.elt58, align 8
  %9 = insertvalue %"[c-flat]:Vec<T = char>" %8, i64 %tmp18.unpack.unpack59, 1
  %tmp18.unpack.elt60 = getelementptr inbounds nuw i8, ptr %file, i64 16
  %tmp18.unpack.unpack61 = load i64, ptr %tmp18.unpack.elt60, align 8
  %tmp18.unpack62 = insertvalue %"[c-flat]:Vec<T = char>" %9, i64 %tmp18.unpack.unpack61, 2
  %fun_call_tmp.i = call {} @"[c-flat]:Vec<T = char>:drop.13"(%"[c-flat]:Vec<T = char>" %tmp18.unpack62)
  br label %merge
}
...
define i1 @"[c-flat]:File:exists"({ ptr, i64 } %0) {
entry:
  %tmp2 = alloca %"[c-flat]:Vec<T = char>", align 8
...
define %"[c-flat]:File" @"[c-flat]:File:open"({ ptr, i64 } %0) {
entry:
  %fun_call_tmp = call %"[c-flat]:Vec<T = char>" @"[c-flat]:[char]:to_string"({ ptr, i64 } %0)
  %tmp_constructor = insertvalue %"[c-flat]:File" undef, %"[c-flat]:Vec<T = char>" %fun_call_tmp, 0
  ret %"[c-flat]:File" %tmp_constructor
}
...
define %"[c-flat]:Vec<T = char>" @"[c-flat]:File:read_text"(ptr %0) {
entry:
  %data = alloca %"[c-flat]:mem:Manually_Drop<T = Vec<T = u8>>", align 8
  %fun_call_tmp = call %"[c-flat]:Vec<T = u8>" @"[c-flat]:File:read"(ptr %0)
...
define %"[c-flat]:Vec<T = u8>" @"[c-flat]:File:read"(ptr %0) {
entry:
  %tmp2 = alloca %"[c-flat]:Vec<T = char>", align 8
...
define {} @"[c-flat]:File:clear"(ptr %0) {
entry:
  %tmp1 = alloca %"[c-flat]:Vec<T = char>", align 8
  %fun_call_tmp = call %"[c-flat]:Vec<T = char>" @"[c-flat]:Vec<T = char>:c_string"(ptr %0)
  %fun_call_tmp.elt = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 0
  ...
  %fun_call_tmp.elt10 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 1
  store i64 %fun_call_tmp.elt10, ptr %tmp1.repack9, align 8
  %tmp1.repack11 = getelementptr inbounds nuw i8, ptr %tmp1, i64 16
  %fun_call_tmp.elt12 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 2
  store i64 %fun_call_tmp.elt12, ptr %tmp1.repack11, align 8
  %fun_call_tmp1 = call { ptr, i64 } @"[c-flat]:Vec<T = char>:deref_mut"(ptr nonnull %tmp1)
  %ref.i = extractvalue { ptr, i64 } %fun_call_tmp1, 0
  %fun_call_tmp3 = call {} @c_write_file(ptr %ref.i, ptr null, i64 0)
  %tmp4.unpack = load ptr, ptr %tmp1, align 8
  %1 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp4.unpack, 0
  %tmp4.elt13 = getelementptr inbounds nuw i8, ptr %tmp1, i64 8
  %tmp4.unpack14 = load i64, ptr %tmp4.elt13, align 8
  %2 = insertvalue %"[c-flat]:Vec<T = char>" %1, i64 %tmp4.unpack14, 1
  %tmp4.elt15 = getelementptr inbounds nuw i8, ptr %tmp1, i64 16
  %tmp4.unpack16 = load i64, ptr %tmp4.elt15, align 8
  %tmp417 = insertvalue %"[c-flat]:Vec<T = char>" %2, i64 %tmp4.unpack16, 2
  %fun_call_tmp5 = call {} @"[c-flat]:Vec<T = char>:drop.13"(%"[c-flat]:Vec<T = char>" %tmp417)
  ret {} zeroinitializer
}

declare {} @c_write_file(ptr, ptr, i64)

define {} @"[c-flat]:File:write_text"(ptr %0, { ptr, i64 } %1) {
entry:
  %fun_call_tmp5 = call {} @"[c-flat]:File:write"(ptr %0, { ptr, i64 } %1)
  ret {} zeroinitializer
}

define {} @"[c-flat]:File:write"(ptr %0, { ptr, i64 } %1) {
entry:
  %tmp2 = alloca %"[c-flat]:Vec<T = char>", align 8
  %data = alloca { ptr, i64 }, align 8
  %.elt = extractvalue { ptr, i64 } %1, 0
  store ptr %.elt, ptr %data, align 8
  %data.repack19 = getelementptr inbounds nuw i8, ptr %data, i64 8
  %.elt20 = extractvalue { ptr, i64 } %1, 1
  store i64 %.elt20, ptr %data.repack19, align 8
  %fun_call_tmp = call %"[c-flat]:Vec<T = char>" @"[c-flat]:Vec<T = char>:c_string"(ptr %0)
  %fun_call_tmp.elt = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 0
  store ptr %fun_call_tmp.elt, ptr %tmp2, align 8
  %tmp2.repack21 = getelementptr inbounds nuw i8, ptr %tmp2, i64 8
  %fun_call_tmp.elt22 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 1
  store i64 %fun_call_tmp.elt22, ptr %tmp2.repack21, align 8
  %tmp2.repack23 = getelementptr inbounds nuw i8, ptr %tmp2, i64 16
  %fun_call_tmp.elt24 = extractvalue %"[c-flat]:Vec<T = char>" %fun_call_tmp, 2
  store i64 %fun_call_tmp.elt24, ptr %tmp2.repack23, align 8
  %fun_call_tmp1 = call { ptr, i64 } @"[c-flat]:Vec<T = char>:deref_mut"(ptr nonnull %tmp2)
  %ref.i = extractvalue { ptr, i64 } %fun_call_tmp1, 0
  %tmp3.unpack = load ptr, ptr %data, align 8
  %tmp5.elt28 = getelementptr inbounds nuw i8, ptr %data, i64 8
  %tmp5.unpack29 = load i64, ptr %tmp5.elt28, align 8
  %fun_call_tmp7 = call {} @c_append_file(ptr %ref.i, ptr %tmp3.unpack, i64 %tmp5.unpack29)
  %tmp8.unpack = load ptr, ptr %tmp2, align 8
  %2 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp8.unpack, 0
  %tmp8.elt31 = getelementptr inbounds nuw i8, ptr %tmp2, i64 8
  %tmp8.unpack32 = load i64, ptr %tmp8.elt31, align 8
  %3 = insertvalue %"[c-flat]:Vec<T = char>" %2, i64 %tmp8.unpack32, 1
  %tmp8.elt33 = getelementptr inbounds nuw i8, ptr %tmp2, i64 16
  %tmp8.unpack34 = load i64, ptr %tmp8.elt33, align 8
  %tmp835 = insertvalue %"[c-flat]:Vec<T = char>" %3, i64 %tmp8.unpack34, 2
  %fun_call_tmp9 = call {} @"[c-flat]:Vec<T = char>:drop.13"(%"[c-flat]:Vec<T = char>" %tmp835)
  ret {} zeroinitializer
}

declare {} @c_append_file(ptr, ptr, i64)

define {} @"[c-flat]:File:delete"({ ptr, i64 } %0) {
entry:
  %tmp2 = alloca %"[c-flat]:Vec<T = char>", align 8
  %tmp1 = alloca %"[c-flat]:Vec<T = char>", align 8
  %fun_call_tmp = call %"[c-flat]:Vec<T = char>" @"[c-flat]:[char]:to_string"({ ptr, i64 } %0)
  ...
  %fun_call_tmp2 = call { ptr, i64 } @"[c-flat]:Vec<T = char>:deref_mut"(ptr nonnull %tmp2)
  %ref.i = extractvalue { ptr, i64 } %fun_call_tmp2, 0
  %fun_call_tmp4 = call {} @c_delete_file(ptr %ref.i)
  %tmp5.unpack = load ptr, ptr %tmp2, align 8
  %1 = insertvalue %"[c-flat]:Vec<T = char>" poison, ptr %tmp5.unpack, 0
  %tmp5.elt25 = getelementptr inbounds nuw i8, ptr %tmp2, i64 8
  %tmp5.unpack26 = load i64, ptr %tmp5.elt25, align 8
...
then:                                             ; preds = %entry
  %fun_call_tmp1 = call %"[c-flat]:Vec<T = char>" @"[c-flat]:[char]:to_string"({ ptr, i64 } { ptr @global_string.30, i64 1 })
